    ...
    () => {
      ...
      media.add(
        ...
        () => {
          ...
          /*
           * Entire Focus composition
           * climbs until marquee reaches
           * approximately viewport center.
           *
           * 86svh - 34svh = 52svh.
           */
          ...
          /*
           * Horizontal travelling happens
           * while the row climbs.
           */
          ...
          /*
           * Old About content may now be
           * cleared because it has left
           * the visible area.
           */
           ...
           * fade-out for Focus or marquee.
           *
           * The following stripe section
           * physically covers them.
           *
           * That is the behaviour we were
           * previously missing.
           */
        },
      );
      ...
      >
        ...
        >
          <h2
            ...
            className="
              max-w-[1260px]
              text-[clamp(3.15rem,4.55vw,5.2rem)]
              font-normal
              leading-[1.015]
              tracking-[-0.058em]
            "
          ...
          >
            <div
              ...
              className="
                ...
                items-center
                whitespace-nowrap
                text-[clamp(5rem,7.35vw,8.35rem)]
                font-normal
                uppercase
                leading-none
                tracking-[-0.066em]
