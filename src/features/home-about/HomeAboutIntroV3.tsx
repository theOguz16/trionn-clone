...
const NARRATIVE_ABOUT_END = 0.92;
  ...
  useGSAP(
    () => {
      ...
      const setCanvasOpacity = (localProgress: number) => {
        ...
        const fade = clamp01((localProgress - 0.58) / 0.14);
        heroCanvas.style.setProperty(
          "--home-narrative-canvas-opacity",
          (1 - fade).toFixed(4),
        );
      ...
      media.add(
        ...
        () => {
          ...
          gsap.set("[data-focus-stage]", { y: 0 });
          gsap.set(
            ["[data-focus-label]", "[data-focus-marquee]"],
            { autoAlpha: 0 },
          );
          gsap.set("[data-focus-label]", { y: 34 });
          gsap.set(marquee, { x: "-6vw" });
    ...
    >
      ...
      <div className="sticky top-0 h-[100svh] overflow-hidden">
        ...
        >
          ...
          <div
            data-focus-marquee
            className="absolute left-0 top-[86svh] z-[40] w-full overflow-visible text-[#dededb]"
          >
            <div
              ref={marqueeRef}
